...
DROP PROCEDURE 
GO
CREATE PROCEDURE [dbo].[fixImportarPersonalRUSP]
AS 
BEGIN
...
INSERT INTO @RUSPPersonal(Personal,	RUSPCatSexo,	RUSPEntFederativaN,	RUSPPaisNacimiento,	RUSPInstitutoSS,	RUSPTipoDiscapacidad,	RUSPTipoContratacion,	RUSPDebeDeclararPatrimonio,	RUSPDecPatrimonial,	RUSPArea,	RUSPNRespContPub,	RUSPNRespConcLicPer,	RUSPNRes
pEnaBienes,	RUSPNRespAsignaEmision,	RUSPCatInmuebles,	RUSPTipoServidorPublico,	RUSPNivelEscolaridad)
SELECT Personal,	RUSPCatSexo,	RUSPEntFederativaN,	RUSPPaisNacimiento,	RUSPInstitutoSS,	RUSPTipoDiscapacidad,	RUSPTipoContratacion,	RUSPDebeDeclararPatrimonio,	RUSPDecPatrimonial,	RUSPArea,	RUSPNRespContPub,	RUSPNRespConcLicPer,	RUSPNRespEnaBienes,	RUSPNRe
spAsignaEmision,	RUSPCatInmuebles,	RUSPTipoServidorPublico,	RUSPNivelEscolaridad 
FROM RUSPPersonal 
